...
start = dt.datetime(2014,10,14)
end = dt.datetime(2020,3,26)

df = web.DataReader('SPYD.DE', 'yahoo', start, end)
df2 = web.DataReader('IS3R.F', 'yahoo', start, end)
df3 = web.DataReader('IWDP.MI', 'yahoo', start, end)
